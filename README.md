# electron-gui-crypto-miner

### Cross-platform GUI application to easily mine cryptocurrency as part a pool
...
```bash
git clone --depth=1 https://github.com/chrisknepper/electron-gui-crypto-miner.git your-project-name
```
...
```sh
git remote add upstream https://github.com/chrisknepper/electron-gui-crypto-miner.git
```
...
## License
MIT © [Chris Knepper](https://github.com/chrisknepper)
Based on electron-react-boilerplate © [C. T. Lin](https://github.com/chentsulin)

[github-tag-url]: https://github.com/chrisknepper/electron-gui-crypto-miner/releases/latest
